...
hist(as.numeric(df$Global_active_power), col="red", xlab="Global Active Power (kW)", main="Global Active Power")
dev.copy(png, width=480, height=480, units="px", file="./plot1.png"); dev.off()
